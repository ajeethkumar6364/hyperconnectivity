...
set namfile [open unr-final.nam w]
#$ns namtrace-all $namfile

set wireless_tracefile [open unr-final.tr w]
...
$ns at 0.0 "$node(7) label mobile_node"
...
proc finish {} {
	...
	$ns flush-trace
	close $namfile
	exec nam -r 2000.000000us unr-final.nam &
	puts "Running the Wimax simulation......"
	exit 0
	}
