...
set namfile [open multicastsch.nam w]
#$ns namtrace-all $namfile

set wireless_tracefile [open multicastsch.tr w]
...
#$ns at 0.0 "$node(17) label Mobile_node"
...
#$ns at 0.0 "$node(17) label Mobile_sensor"
...
proc finish {} {
	...
	$ns flush-trace
	close $namfile
	exec nam -r 2000.000000us multicastsch.nam &
	puts "Running......"
	exit 0
	}
