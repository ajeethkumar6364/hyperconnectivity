...
$ns at 1.0 "$node(1) setdest 550.0 1.0 30.0"
$ns at 1.0 "$node(2) setdest 285.0 10.0 30.0"
$ns at 1.0 "$node(3) setdest 450.0 20.0 30.0"
$ns at 1.0 "$node(4) setdest 285.0 10.0 50.0"
$ns at 1.0 "$node(5) setdest 550.0 2.0 30.0"
$ns at 1.0 "$node(6) setdest 125.0 15.0 30.0"

$ns at 0.0 "$node(1) label WC_Node"
$ns at 0.0 "$node(1) color RED"


$ns at 0.0 "$node(2) label WC_Node"
$ns at 0.0 "$node(2) color RED"
$ns at 0.0 "$node(3) label WC_Node"
$ns at 0.0 "$node(3) color RED"
$ns at 0.0 "$node(4) label WC_Node"
$ns at 0.0 "$node(4) color RED"
$ns at 0.0 "$node(5) label WC_Node"
$ns at 0.0 "$node(5) color RED"
$ns at 0.0 "$node(6) label WC_Node"
...
$ns at 0.0 "$node(9) label AP_1"
$ns at 0.0 "$node(9) color gold"
$ns at 0.0 "$node(10) label AP_2"
